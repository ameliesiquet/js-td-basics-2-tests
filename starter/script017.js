...
const height= NaN;
if (height || height ===0){
    console.log("La variable height es définie");
}else {
...
*/
const height2 = 20;
if (height2 !== undefined && height2 !== 0) {
...
*/
if (23 === `23`) {
    console.log("J'ai testé si 23 était égal à '23' sans vérifier le type. L'opérateur que 'ai utilisé a opéré une conversion de type")
}else{
